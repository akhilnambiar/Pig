...
def run_strategy_experiments():
    ...
    print(eval_strategy_range(make_die_specific_strategy,15,25))
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    "*** YOUR CODE HERE ***"
    gap = opponent_score+15
    margin_goal=gap-score
    if (score+opponent_score)%7==0:
        return make_roll_until_plan(8)
    else:
        if score>80:
            return make_roll_until_plan(100-score)
        else:
            if score<=gap and margin_goal>17:
                return make_roll_until_plan(margin_goal)
            else:
